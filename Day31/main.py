...
wrong_button = Button(image=wrong_image, highlightthickness=0, command=handle_button_click)
wrong_button.grid(row=1, column=0)

right_image = PhotoImage(file="images/right.png")
right_button = Button(image=right_image, highlightthickness=0, command=handle_button_click)
